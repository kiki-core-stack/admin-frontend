...
const currentInterval = ref<null | number>(props.defaultSeconds);
const countdown = ref<null | number>(currentInterval.value);
...
// Functions
function setIntervalSeconds(seconds: null | number) {
