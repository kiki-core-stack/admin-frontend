...
const permissionLabels: Record<AdminPermission | AdminPermissionGroup, string> = {
    ...
    'admin.update': '更新管理員',
    'email': '電子郵件',
    'email.provider': '電子郵件服務商',
    'email.provider.create': '建立電子郵件服務商',
    'email.provider.delete': '刪除電子郵件服務商',
    'email.provider.list': '獲取電子郵件服務商列表',
    'email.provider.toggle': '切換電子郵件服務商狀態',
    'email.provider.update': '更新電子郵件服務商',
